...
const VideoCard = ({ video: { id: { videoId }, snippet } }) => {
  ...
  return (
    <Card style={{ width: '300px', height: '300px', overFlow: "hidden", color: "#000" }} sx={{ md: '300px', sm: 'auto', lg: '300px', justifyContent: 'flex-start' }}  >
      ...
      <CardContent height='180px' width="25%" >
        <Link to={videoId ? `/video/${videoId}` : `video/demoVideoUrl`}>
          ...
          <span sx={{ display: 'flex', alignItem: 'center', width: '100px' }} className='subscribe'>
            <Button variant="outlined" sx={{ height: '25px', color: '#001', mt: '4px', mb: '4px', background: 'red', fontSize: '10px' }}>Subscribe
            </Button><CheckCircle />
          </span>
